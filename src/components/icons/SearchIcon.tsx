...
const SearchIcon = memo<JSX.IntrinsicElements["svg"]>((props) => {
  return (
    <svg {...props} width="24" height="24" viewBox="0 0 48 48" fill="rgba(22, 24, 35, .34)" xmlns="http://www.w3.org/2000/svg">
